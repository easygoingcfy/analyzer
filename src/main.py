...
def main():
    ...
    print(f"-"*50)
    print(f"当前盈亏: {stats['当前盈亏']:.2f}")
    print(f"盈亏率: {stats['盈亏率']:.2f}%")
    print(f"总买入成本: {stats['总买入成本']:.2f}")
    print(f"总买入税费: {stats['总买入税费']:.2f}")
    print(f"总卖出收入: {stats['总卖出收入']:.2f}")
    print(f"总卖出税费: {stats['总卖出税费']:.2f}")
    print(f"-"*50)
    ...
    print(f"单笔最大盈利: {stats['单笔最大盈利']:.2f}")
    print(f"单笔最大亏损: {stats['单笔最大亏损']:.2f}")
    print(f"{'='*50}")
